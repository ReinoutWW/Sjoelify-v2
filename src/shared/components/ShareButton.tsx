        ...
        {showShareModal && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-4 bottom-4 sm:inset-auto sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 bg-white rounded-2xl shadow-xl z-50 w-auto sm:w-full sm:max-w-sm"
            >
              <div className="p-6">

          ...
          <div className="mt-2 grid grid-cols-1 gap-3">
            {filteredPlayers.length > 0 ? (
              ...
              >
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">No players available</h3>
                <p className="mt-1 text-sm text-gray-500">
                  {searchTerm
                    ? 'No players found matching your search'
                    : 'Share the app with friends to start playing together!'}
                </p>
                {!searchTerm && (
                  <div className="mt-6">
                    <button
                      ...
                      className={`inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white transition-colors duration-200 ${
                        isCopied ? 'bg-green-600' : 'bg-primary-600 hover:bg-primary-700'
